...
export const galeriList: FotoGaleri[] = [
  {
    id: "galeri-1",
    src: "https://images.unsplash.com/photo-1595151830531-c79a1a8c08ec?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    alt: "TODO: Survei audit energi rumah tangga Desa Batursari",
    caption: "TODO: Kegiatan survei audit penggunaan energi listrik pada salah satu rumah warga di Desa Batursari.",
  },
  {
    id: "galeri-2",
